<form action="{{route('store.cov')}}" method="POST">
    @csrf
    <input type="hidden" id="id4" name="user_id">
    <input type="hidden" id="doc4" name="doctor">
    <input type="hidden" id="ord4" name="orden">
    ...
    <div class="table-responsive" style="border: 1px solid black">
        <table class="table center">
            ...
            <tbody>
                <tr>
                    ...
                    <th style="text-align: center"><input type="text" name="antigenoCov" class="form-control" style=" margin-left:20px; width:300px;">
                    </th>
                    <th></th>
                </tr>
                <tr>
                    <th class="d-flex">Metodo:<input type="text" name="metodo" class="form-control" style=" margin-left:20px; width:300px;"></th>
                    <th></th>
                    <th></th>
                </tr>
                <tr>
                    <th class="d-flex">Muestra:<input type="text" name="muestra" class="form-control" style=" margin-left:20px; width:300px;"></th>
                    <th></th>
                    <th></th>
                </tr>
            </tbody>
        ...
        <div class="form-group">
            ...
            <textarea class="ckeditor form-control" name="interpretacion"></textarea>
