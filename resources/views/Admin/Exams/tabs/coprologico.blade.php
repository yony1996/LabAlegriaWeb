<form  action="{{route('store.copro')}}" method="POST">
    ...
    <input type="hidden" id="doc2" name="doctor">
    <input type="hidden" id="ord2" name="orden">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" name="examFisiResA[]">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                <hr>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" name="examMicroAlm[]">
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" name="examMicroGra[]">
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" name="examMicroFloB[]">
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Parásitos:</td>
                                                        <td>
                                                            <input type="text" class="form-control" name="examMicroPar[]">
                                                        </td>
                                                        <td>
                                                        </td>
                                                        <td>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Metodo</td>
                                                        <td>
                                                            <input type="text" class="form-control" name="sangreOcMet[]">
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
