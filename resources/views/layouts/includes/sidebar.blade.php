            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="page-layouts" style="">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="{{ route('exam') }}">Gestionar
                                Examenes</a>
                        </li>
                        <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="{{ route('results') }}">Ver
                                resultados</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="page-layouts" style="">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @endrole
                        <li class="nav-item"> <a class="nav-link" href="{{ route('exam.create') }}">Crear resultados</a>
                        </li>
                        <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="{{ route('results') }}">Ver
                                resultados</a></li>
                    </ul>
